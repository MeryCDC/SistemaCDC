                    ...
                    <div class="d-sm-flex align-items-center justify-content-between border-bottom">
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                                ...
                                {{-- <a class="nav-link" id="home-tab" data-bs-toggle="tab" role="tab" aria-controls="overview" aria-selected="true">Ingreso #: {{ $id }} </a> --}}
                            </li>
                            <li class="nav-item">
                    ...
                    <form action="{{ url('/minutas') }}" class="forms-sample" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('Fecha_Prox_Reuniun') is-invalid @enderror"
                                id="Fecha_Prox_Reuniun" name="Fecha_Prox_Reuniun"
                                value="{{ old('Fecha_Prox_Reuniun') }}">
