    ...
    <div style="margin:3px; padding:3px; text-align:center; vertical-align:middle;">
        ...
        <table border="0" width="377" height="500">
            <tbody>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="text-align: right;">
                                        <span style="font-size: 13px; font-weight: bold;"> {{ date('Y-m-d H:i') }}
                                        </span>
                                    </td>
                                </tr>
                            </tbody>
                ...
                @foreach ($guiaBodega as $guia)
                    <tr>
                        <td align="left" style="padding-left: 15px;">
                            <table>
                                <tbody> 
                                    <tr>
                                        <td style="vertical-align: top; font-size: 20px;"><b>ID:</b> {{ $guia->id }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="vertical-align: top; font-size: 20px;"><b>Dimensiones:</b>
                                            {{ $guia->alto }} x {{ $guia->largo }} x {{ $guia->ancho }} in</td>
                                    </tr>
                                    <tr>
                                        <td style="vertical-align: top; font-size: 20px;"><b>Peso:</b>
                                            {{ $guia->peso }} lb</td> 
                                    </tr>
                                    <tr>
                                        <td style="vertical-align: top; font-size: 20px;"><b>Codigo de Ingreso:</b>
                                            {{ $guia->int_impo_id }}</td> 
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <tbody>
                                <tr>
                                    <td align="center" style="padding: 2px;">
                                        <span style="font-size: 14px; font-weight: bold;">PAQUETE SIN
                                            IDENTIFICAR</span><br>
                                    </td>
                                </tr>
                            </tbody>
